...
test('bare expressions not allowed', () => throws(() => CoffeeScript.compile('<div x=y />')));

test('bare complex expressions not allowed', () => throws(() => CoffeeScript.compile('<div x=f(3) />')));
